...
public class Signup extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_register).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String txt_gender = ((RadioButton) findViewById(radioGroupGender.getCheckedRadioButtonId())).getText().toString();
    ...
    private boolean validate(String txt_fullname, String txt_username, String txt_email, String txt_password, String txt_c_password) {
        boolean valid = true;
    ...
    private void RegisterNewAccount(final String fullname, final String username, final String email, final String password, final String gender) {
