...
model_type = "RightLane_MobileNetV2"
start_time = time.time()
os.environ['CUDA_VISIBLE_DEVICES'] = '-1'

train_path = 'C:/Users/Roman/Documents/Python/Project/Data/lineSet Right/train'
test_path = 'C:/Users/Roman/Documents/Python/Project/Data/lineSet Right/test'
eval_path = 'C:/Users/Roman/Documents/Python/Project/Data/lineSet Right/eval'
...
for cut in range(0, 1):  # ----------------------------------------------------- number of top layers cut
    # for layers_to_train in range(1, 31):  # ------------------------------------ number of top layers to train
        for epochs in range(13, 25):  # ------------------------------------------ number of epochs
