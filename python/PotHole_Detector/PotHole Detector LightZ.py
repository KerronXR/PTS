...
from PotHole_Detector import UtilsZ
...
out = cv.VideoWriter('C:/Users/Roman/Documents/Python/Project/Data/image_video_data/res1.avi', fourcc, 20.0,
                     (1280, 720))

# logo = cv.imread('C:/Users/Roman/Documents/Python/Project/Data/image_video_data/AgrmsSmall.png')
# test_frame = cv.imread('C:/Users/Roman/Documents/Python/Project/Data/image_video_data/Agrms_Blended1.png')

# fps = cap.get(cv.CAP_PROP_FPS)
initial_trackbar_values = [0, 0, 1, 60, 10]
# wT,hT,wB,hB, thresh_val, adapt_val, HT, BlockSize, SubConst
UtilsZ.initialize_trackbars(initial_trackbar_values)
frameCount = 0
count = 0
while cap.isOpened():
    ...
    if cv.waitKey(30) & 0xFF == 27:
        break
    if ret:
        val_trackbars = UtilsZ.val_trackbars()
        ...
        cropped_frame = UtilsZ.region_of_interest(canny_image,
                                                  np.array([region_of_interest_vertices], np.int32), )
        roi_frame = UtilsZ.find_road_area(cropped_frame, frame, grey_copy)
        result_frame = UtilsZ.detect_holes(roi_frame[0], roi_frame[1], val_trackbars, count)
        # count += 2
        ...
        cv.putText(result_frame, 'Scanned with iPhone X', (10, 100),
                   cv.FONT_HERSHEY_SIMPLEX, 1, (150, 255, 150), 2, cv.LINE_AA)
